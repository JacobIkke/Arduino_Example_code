...
#define OVERSAMPLING_RATIO 500 // This increases the accuracy and average filtering
#define RESOLUTION_INCREASE 10 // This increases the ADC value, in this case from 0-1024 to 0-10240
